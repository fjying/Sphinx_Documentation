...
from ..construct_models_gurobi import (
    default_params,
    garver_3bin_vars,
    garver_power_vars,
...
def generate_model(
    ...
    if model._power_balance == "ptdf_power_flow":
        _ptdf_options = populate_default_ptdf_options(ptdf_options)

        baseMVA = model_data.get_system_attr("baseMVA")
        check_and_scale_ptdf_options(_ptdf_options, baseMVA)
